...
// ********************************************************************
//
// $Id: DANCEGeneralPhysics.cc,v 1.5 2004/11/23 04:02:02 tkoi Exp $
// --------------------------------------------------------------
//
...
DANCEGeneralPhysics::~DANCEGeneralPhysics()
{
}
...
void DANCEGeneralPhysics::ConstructParticle()
{
/*
...
void DANCEGeneralPhysics::ConstructProcess()
{
  // Add Decay Process
...
//      particle->SetPDGLifeTime(0.);
  ...
  for (G4int i=0; i<theIonTable->Entries(); i++)
	...
	{
//	  theIonTable->GetParticle(i)->SetPDGLifeTime(0.);
	  G4ProcessManager* pmanager = theIonTable->GetParticle(i)->GetProcessManager();

// this one is for Geant4.8.0 patch1+
	
	  // theIonTable->GetParticle(i)->SetAtomicMass(1);	
	  ...
	  pmanager ->SetProcessOrdering(theRadioactiveDecay, idxAtRest);
   	...
   	//theIonTable->GetParticle(i)->DumpTable(); 
    	}
    } 
